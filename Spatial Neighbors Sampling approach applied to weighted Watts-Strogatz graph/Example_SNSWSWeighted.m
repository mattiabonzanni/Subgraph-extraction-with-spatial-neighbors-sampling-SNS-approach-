...
%% Example
clc
NG=500;             % number of nodes in the global WS graph
k=15;               % mean node degree 2*K
beta=0.05;          % rewiring probability
percentage=20;      % percentage of nodes to extract

[Final FinalMean]=SNSWSWeighted(NG, k, beta, percentage);       %If not specified, InitialSeedNode=1 and LasteSeedNode=NG.
