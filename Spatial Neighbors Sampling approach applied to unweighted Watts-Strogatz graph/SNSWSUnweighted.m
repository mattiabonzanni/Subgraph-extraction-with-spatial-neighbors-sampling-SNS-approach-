...
for i=InitialSeedNode:LastSeedNode
% Extract all the nodes with an index in the range [i; i+nodeFraction]. The edges are maintained if and only if both nodes are retained in the subgraph; 
Vertex=i;
