%% Distance-Dependent Model (DDM) generation and application of the spatial neighbors sampling (SNS) method of subgraph extractions
...
[G MatrixG xcoord ycoord FinalGlobalGraph]=GenerateDDM(NG,edgeDensity,beta);       
[FinalSubgraphs]=SNSDDM(G,rho, xcoord, ycoord, NG,InitialSeedNode,LastSeedNode);